<template>
  <div>
    <b-container v-if="loading" class="py-5 mt-5 mb-5">
      <b-col class="py-5 mt-5 mb-5 border">
        <h6 class="text-center"><b-icon icon="circle-fill" animation="throb" font-scale="1.2"></b-icon> Fetching...</h6>
      </b-col>
    </b-container>
                  ...
                  <b-card title="Card Title" no-body>
                    ...
                    <b-card-body>
                      <div v-if="tab_active === 'posts'">
                        <UserTweets @onLiked="updateTweetList" :tweets="profile.tweets" />
                      </div>
